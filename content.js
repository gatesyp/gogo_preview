window.onclick = function() {
    ...
    for(var i = 0; i < links.length; i++) { 
        if ( links[i].href.includes("linkedin.com") ) {
            ...
            if(stevenbox){
                stevenbox.innerHTML = '<iframe src="' + links[i].href + '" width = "1000px" height = "500px"></iframe>'
            } else {
                htmlString = '<div id="STEVENBOX" style="z-index: 100;position: absolute;display: none;width: 100%;}"><iframe src="' + links[i].href + '" width = "500px" height = "500px"></iframe></div>'
